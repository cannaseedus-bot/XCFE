...
class Engine:
    ...
    def apply_command(self, cmd: Dict[str, Any]) -> None:
        ...
        if op == "ui.create":
            self._op_ui_create(cid=cmd_id, ts_ms=ts_ms, args=args)
        elif op == "ui.theme.apply":
            self._op_theme_apply(cid=cmd_id, ts_ms=ts_ms, args=args)
        elif op == "svg.export":
    ...
    def _op_ui_create(self, *, cid: str, ts_ms: int, args: Dict[str, Any]) -> None:
        ...
        comp = {"id": comp_id, "type": comp_type, "props": props}
